...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            <a href="{{ route('pages.homepage') }}" class="navbar-brand ml-lg-3">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    <a href="{{ route('pages.homepage') }}" class="nav-item nav-link active">Home</a>
                    <a href="{{ route('pages.about') }}" class="nav-item nav-link">About</a>
                    <a href="{{ route('pages.course') }}" class="nav-item nav-link">Courses</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu m-0">
                            <a href="{{ route('pages.detail') }}" class="dropdown-item">Course Detail</a>
                            <a href="{{ route('pages.features') }}" class="dropdown-item">Our Features</a>
                            <a href="{{ route('pages.istructors') }}" class="dropdown-item">Instructors</a>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="contact-form">
                        ...
                        <form action="{{ route('send_mail') }}" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control border-top-0 border-right-0 border-left-0 p-0" name="sub" placeholder="Subject" required="required">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control border-top-0 border-right-0 border-left-0 p-0" rows="5" name="mess" placeholder="Message" required="required"></textarea>
                            </div>
                            <div>
