                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="study_title"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Study Title') }}</label>

                                <div class="col-md-6">
                                    <input id="study_title" type="text"
                                        class="form-control @error('study_title') is-invalid @enderror" name="study_title"
                                        value="{{ old('study_title') }}" required autocomplete="study_title" autofocus>
